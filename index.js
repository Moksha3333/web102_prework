...
contributionsCard.innerHTML = `Individual Contributions: ${totalContributions.toLocaleString()}`;
...
const summaryString = `
    ${totalContributions.toLocaleString()} individual contributions have been made, 
    raising $${totalPledged.toLocaleString()} for ${GAMES_JSON.length} games. 
    ${unfundedGamesCount > 0 ?
    `${unfundedGamesCount} game${unfundedGamesCount > 1 ? 's' : ''} ${unfundedGamesCount === 1 ? 'remains' : 'remain'} unfunded.` :
